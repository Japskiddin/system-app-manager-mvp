...
public class AppsInteractorImpl implements AppsInteractor {
    ...
    public List<AppInfo> filterApps(int currentList, List<AppInfo> mAppsList) {
        return filterAppList(currentList, mAppsList);
    }

    private List<AppInfo> filterAppList(int currentList, List<AppInfo> mAppsList) {
    ...
    public static void sortAppList(List<AppInfo> apps) {
